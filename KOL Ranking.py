...
def selectField(choice):
    if choice == "Technology":
        # Cho phép người dùng nhập thêm tên Channel mà họ muốn
        # for i in range(len(tech)):
        #     print(tech[i])
        # addYes = input("Here's the list, do you want to add another channel? (Y/N)")
        # if addYes == "Y" or addYes == "y":
        #     newTechChannel = input("Enter the channel's name: ")
        #     tech.append(newTechChannel)
        #     flag = True
        # else:
        #     flag = False
        # while flag == True:
        #     addYes = input("Add another? (Y/N)")
        #     if addYes == "Y" or addYes == "y":
        #         newTechChannel = input("Enter the channel's name: ")
        #         tech.append(newTechChannel)
        #     else:
        ...
        # addYes = input("Here's the list, do you want to add another channel? (Y/N)")
        # if addYes == "Y" or addYes == "y":
        #     newChannel = input("Enter the channel's name")
        #     beauty.append(newChannel)
        #     flag = True
        #     while flag == True:
        #         addYes = input("Add another? (Y/N)")
        #         if addYes == "Y" or addYes == "y":
        ...
        # if addYes == "Y" or addYes == "y":
        #     newChannel = input("Enter the channel's name")
        #     food.append(newChannel)
        #     flag = True
        #     while flag == True:
        #         addYes = input("Add another? (Y/N)")
        #         if addYes == "Y" or addYes == "y":
        #             newChannel = input("Enter the channel")
        #             food.append(newChannel)
        #         else:
        #             flag = False
        data = main(food)
...
def convert_to_numberString(dfMerge):
    ...
    # PHẦN NÀY VỪA CHỈNH SỬA

    dfMerge = dfMerge.drop(['Unnamed: 0'], axis=1)
    # dfMerge = dfMerge.fillna(dfMerge.mean()) # Doesn't work yet cause still string


# Tạo historgram và chuyển về thang histogram. VD: 2 tr lượt sub -> 4đ
